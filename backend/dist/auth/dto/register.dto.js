...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'juan@example.com', description: 'Correo electrónico del usuario' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'juanperez', description: 'Nombre de usuario' }),
    (0, class_validator_1.IsString)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'client', description: 'Rol del usuario (client o business)', required: false }),
    (0, class_validator_1.IsString)(),
